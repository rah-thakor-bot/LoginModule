...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let logginCredential = NSUserDefaults.standardUserDefaults()
        if (logginCredential.boolForKey("authenticatedUser")){
            print("AuthenticatedUser : \(logginCredential.boolForKey("authenticatedUser"))")
            //Get StoryBoard
            let storyboard = UIStoryboard(name: "Main", bundle: NSBundle.mainBundle())
            //Instantiate Initial ViewController
